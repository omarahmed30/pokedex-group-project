...
<<<<<<< HEAD
//adds name to URL to access specific pokemon URL needed 
=======
...
<<<<<<< HEAD
//addes pokemon array as objects to empty trainerOmar array
=======
...
<<<<<<< HEAD
//creates new pokemon by name into Pokemon class set to new var acording to name 
...
//                     let pmon = response.data
//                     this.name = pmon.name
//                     this.ht = pmon.stats[5].base_stat
//                     this.attack = pmon.stats[4].base_stat
//                     this.defense = pmon.stats[3].base_stat
//                     this.abilities = abilities
//                     console.log(pmon.name)
//                     callingObjects(pmon)
//                     // areYouReadyKids();
//                     // console.log(omar)
//                 }).catch((error) => {
